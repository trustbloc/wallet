...
export const testConfig = window.__FIXTURES__ ? JSON.parse(window.__FIXTURES__['test/fixtures/agent-config.json']) : {}
...
export class Setup {
    ...
    async createPreference() {
        ...
        await new WalletUser({agent: this.agent, user: this.user}).savePreferences(this.token, this.preference);
    }
