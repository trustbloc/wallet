...
<template>
  <div class="flex w-full flex-col justify-start px-3 pt-10 md:px-0">
    <div class="root-container flex w-full flex-col items-start justify-start">
      <div
      ...
      >
        ...
        <span
          class="flex-1 text-ellipsis pl-4 text-left text-sm font-bold md:text-base"
