          ...
          <div class="md-layout-item">
            <div v-if="dialogContent === 'acceptRequestPresentationForm'">
              <md-field>
                ...
                <md-textarea v-model="presentation" required></md-textarea>
              </md-field>
              <span v-if="acceptRequestPresentationError" class="error">{{
            ...
            <div v-else-if="dialogContent === 'acceptPresentationForm'">
              <md-field>
                ...
                <md-textarea v-model="presentationNames" required></md-textarea>
              </md-field>
              <span v-if="acceptPresentationError" class="error">{{
          ...
          <md-card class="md-card-plain">
            ...
            <md-card-content style="background-color: white">
              <md-field>
                ...
                <md-textarea v-model="requestPresentation" required></md-textarea>
              </md-field>
              ...
              <div style="display: flow-root">
                <span v-if="sendRequestPresentationError" class="error">{{
                  sendRequestPresentationError
                }}</span>
                <span v-if="sendRequestPresentationSuccess" class="success">{{
...
export default {
  created: async function () {
    this.addAgentNotifiers({
      callback: this.onPresentProofState,
      topics: ['present-proof_states'],
    });
  ...
  methods: {
    ...
    acceptRequestPresentation: async function (action, form) {
      ...
      try {
        ...
        this.acceptRequestPresentationError =
          'Please make sure you are providing a JSON Presentation';
        return;
      }
    ...
    sendRequestPresentation: async function () {
      ...
      try {
        ...
        this.sendRequestPresentationError =
          'Please make sure you are providing a JSON RequestPresentation';
        return;
      }
