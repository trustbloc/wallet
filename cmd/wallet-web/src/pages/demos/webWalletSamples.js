...
const prcbbs = {
  ...
  credentialSubject: {
    ...
    gender: 'Male',
    givenName: 'JOHN',
    id: 'did:orb:AiMP4:EiDZGbGKGpfHo0NreApVT6Kqq6vyecYBmRBFXXRwSWYXcg',
  ...
  proof: {
    ...
    proofPurpose: 'assertionMethod',
    proofValue:
      'hp08VNxXpgOSKvTsxCxBg2y_5yiI0d-dplUbwad24JJlX-GH97mPV0Dz3GesdXXNG-Bm1qwGYmfWdtXOk5eM8F-kSEsts46QZBfbGLkC7UtMKcgpPiorm0DCv0sjRH8OXDeIEOMMIyt1PXA-6ACDsQ',
    type: 'BbsBlsSignature2020',
    verificationMethod:
      'did:key:zUC72tF75rofR3xwYWG1WSkHNqMn6ZAAS3kMucAzfjDZXuQ3d2KcyFZ7Lp8RajtrMxAimzjx7dRQHfgw4RgUESsKHD79W6S7eKUsiTv8ig1Eybz16qpwU2kXrD5nYxzzsMYtwHD#zUC72tF75rofR3xwYWG1WSkHNqMn6ZAAS3kMucAzfjDZXuQ3d2KcyFZ7Lp8RajtrMxAimzjx7dRQHfgw4RgUESsKHD79W6S7eKUsiTv8ig1Eybz16qpwU2kXrD5nYxzzsMYtwHD',
  },
  type: ['VerifiableCredential', 'PermanentResidentCard'],
};
...
const govnVC = {
  ...
  credentialStatus: {
    ...
    revocationListCredential:
      'https://governance-vcs.stg.trustbloc.dev/governance/governance/status/1',
    revocationListIndex: '3',
    type: 'RevocationList2020Status',
  },
  credentialSubject: {
...
const samplePresentation2 = {
  '@context': ['https://www.w3.org/2018/credentials/v1'],
  type: 'VerifiablePresentation',
  verifiableCredential: [prc, vaccinationVC, bookingRefVC],
};
  ...
  service: [
    {
      ...
      RecipientKeys: ['Fy1CAy7D7AxynyBRFMyZB8S2RNoVPPBqgSDERRYJPyM8'],
      RoutingKeys: ['Goobf693U36p7VZkoRCWdtkEJZVTPCzZwbjm77VKiALC'],
...
const manifest = {
  ...
  type: ['VerifiableCredential', 'IssuerManifestCredential'],
};
...
const dl = {
  ...
  proof: {
    ...
    type: 'Ed25519Signature2018',
    verificationMethod:
      'did:orb:interim:EiDNdiR8SzDwHUxM1gI-684r4TXgnIlet4NNjOzl8JxAdA#fchKuTonCSsgeFzActt8VstqKfkR5t6W20W9IP7AghE',
  },
