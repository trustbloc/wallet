            ...
            <template slot="header">
                <div style="font-size: 18px; font-weight: bold; user-select: none">
                    ...
                    <div
                        ...
                        <span v-else style="font-size: 25px; padding: 10px;">

                            <div class="fas fa-cloud-download-alt" v-if="display === 'credentialRequest'">
                            Credentials Request
                            </div>

                            <div class="fas fa-save" v-else>
                                Store Credentials
                            </div>
                ...
                <wrm-hint-chooser
                    ...
                    <template slot="message">
                        ...
                        <div v-if="hintOptions.length > 0">
                            ...
                            <div style="padding-top: 10px">Choose your wallet</div>
                        </div>
