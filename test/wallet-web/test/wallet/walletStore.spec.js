...
describe('store a credential in wallet', () => {
    ...
    it('all credential store metadata are pre-populated in wallet', async () => {
        ...
        expect(wrapper.vm.issuer).to.equal("did:orb:EiC_G_44Xq0hj_JmxLScbtMBjOouSgBNI_HuqPm40-t_Uw")
...
describe('store multiple credentials in wallet', () => {
    ...
    it('all combined credential store metadata are pre-populated in wallet', async () => {
        ...
        expect(wrapper.vm.issuer).to.equal("did:orb:EiC_G_44Xq0hj_JmxLScbtMBjOouSgBNI_HuqPm40-t_Uw,did:orb:EiC_G_44Xq0hj_JmxLScbtMBjOouSgBNI_HuqPm40-t_Uw")
